# How to Configure HTTPS for Athena LLM AWS private deployment
...
**Requirements**
- Successful deployment of Amazon Linux 2023 EC2 instance with Docker container running Athena LLM
...
## Step 7: Create simple http proxy configuration for AthenaLLM 
These instructions are for CLI configuration and assume you are logged in to EC2 instance as the ec2-user.
...
3. Navigate to http://FQDN in a browser and you should be proxied to the AthenaLLM web UI.
...
2. Navigate to https://FQDN in a browser and you should be proxied to the AthenaLLM web UI.
