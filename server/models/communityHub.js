...
/**
 * An interface to the AthenaLLM Community Hub external API.
 */
const CommunityHub = {
   ...
   * so we can unzip and import them to the AthenaLLM instance.
  ...
  /**
   * Apply an item to the AthenaLLM instance. Used for simple items like slash commands and system prompts.
  ...
  /**
   * Import a bundle item to the AthenaLLM instance by downloading the zip file and importing it.
