...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      title: "LLMの設定",
      description:
        "AthenaLLMは多くのLLMプロバイダーと連携できます。これがチャットを処理するサービスになります。",
    },
    userSetup: {
      title: "ユーザー設定",
    ...
    survey: {
      title: "AthenaLLMへようこそ",
      description:
        "AthenaLLMをあなたのニーズに合わせて構築するためにご協力ください。任意です。",
      email: "メールアドレスは何ですか？",
      useCase: "AthenaLLMを何に使用しますか？",
      useCaseWork: "仕事用",
      useCasePersonal: "個人用",
      useCaseOther: "その他",
      comment: "AthenaLLMをどのように知りましたか？",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "最初のワークスペースを作成して、AthenaLLMを始めましょう。",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "AthenaLLMへようこそ。AthenaLLMはMintplex LabsによるオープンソースのAIツールで、あらゆるものをトレーニングされたチャットボットに変換し、クエリやチャットが可能です。AthenaLLMはBYOK（Bring-Your-Own-Keys）ソフトウェアであり、このソフトウェアを使用するためのサブスクリプション、料金、または費用はありません。",
    part2:
      "AthenaLLMは、OpenAi、GPT-4、LangChain、PineconeDB、ChromaDBなどの強力なAI製品を簡単に統合し、手間をかけずに生産性を100倍に向上させる最も簡単な方法です。",
    part3:
      "AthenaLLMは、あなたのマシン上で完全にローカルで動作し、ほとんど負荷をかけません。GPUは必要ありません。クラウドおよびオンプレミスでのインストールも可能です。\nAIツールエコシステムは日々強力になっています。AthenaLLMはそれを簡単に利用できるようにします。",
  ...
  api: {
    title: "APIキー",
    description:
      "APIキーにより、プログラム経由でこのAthenaLLMインスタンスにアクセスおよび管理できます。",
    link: "APIドキュメントを読む",
  ...
  llm: {
    title: "LLMの設定",
    description:
      "これは、お好みのLLMチャットおよび埋め込みプロバイダー用の認証情報と設定です。これらのキーが最新かつ正確でない場合、AthenaLLMは正しく動作しません。",
    provider: "LLMプロバイダー",
  },
  transcription: {
    title: "文字起こしモデルの設定",
    ...
    "warn-start":
      "RAMやCPUが限られたマシンでローカルのWhisperモデルを使用すると、メディアファイルの処理中にAthenaLLMが停止する可能性があります。",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "埋め込みとは、テキストをベクトルに変換するプロセスです。これらの認証情報は、ファイルやプロンプトをAthenaLLMが処理できるフォーマットに変換するために必要です。",
    provider: {
      title: "埋め込みプロバイダー",
      description:
        "AthenaLLMのネイティブ埋め込みエンジンを使用する場合、特に設定は必要ありません。",
    },
  },
  text: {
  ...
  vector: {
    title: "ベクターデータベース設定",
    description:
      "これは、AthenaLLMインスタンスの動作方法用の認証情報と設定です。これらのキーが最新で正確であることが重要です。",
    provider: {
  ...
  multi: {
    ...
    password: {
      title: "パスワード保護",
      description:
        "AthenaLLMインスタンスをパスワードで保護します。これを忘れた場合、回復方法はないため、このパスワードを必ず保存してください。",
    },
    instance: {
  ...
  privacy: {
    title: "プライバシーとデータ処理",
    description:
      "これは、接続されているサードパーティプロバイダーとAthenaLLMがデータをどのように処理するかの設定です。",
    llm: "LLM選択",
    embedding: "埋め込み設定",
    vector: "ベクターデータベース",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "これらのファイルは、このAthenaLLMインスタンス上のドキュメント処理機能にアップロードされます。第三者に送信・共有されることはありません。",
    },
    pinning: {
      what_pinning: "ドキュメントのピン留めとは？",
      pin_explained_block1:
        "AthenaLLMでドキュメントを<b>ピン留め</b>すると、その内容全体がプロンプトウィンドウに挿入され、LLMがしっかり理解できるようになります。",
    ...
    watching: {
      ...
      watch_explained_block1:
        "AthenaLLMでドキュメントを<b>ウォッチ</b>すると、元のソースから定期的に内容が<i>自動的に</i>同期されます。管理しているすべてのワークスペースで内容が自動更新されます。",
  ...
  "main-page": {
    ...
    checklist: {
      title: "はじめに",
      tasksLeft: "残りのタスク",
      completed: "AthenaLLMの達人への道を進んでいます！",
      dismiss: "閉じる",
      tasks: {
        create_workspace: {
          title: "ワークスペースを作成する",
